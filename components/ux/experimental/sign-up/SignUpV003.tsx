...
export function SignUpV003() {
  ...
  return (
    <motion.main
      className="flex min-h-screen items-center justify-center bg-white px-6 py-6 font-['Montserrat',ui-sans-serif,system-ui,sans-serif] text-black"
      ...
      <section className="flex w-full max-w-[448px] flex-col items-center">
        ...
        >
          <div className="px-8 pt-8">
            ...
            <div
              className="mt-6 rounded-[14px] p-[2px] shadow-[0_10px_24px_rgba(255,72,0,0.1)]"
